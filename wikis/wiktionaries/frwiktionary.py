...
class FrWiktionary(Wiktionary):
    ...
    def __create_pronunciation_section(self, wikicode):
        ...
        prev_section.contents = self.__safe_append_text(str(prev_section.contents), EMPTY_PRONUNCIATION_SECTION)
    ...
    def __append_file(self, wikicode, filename, language_qid, location_qid, language_level):
        ...
        section_content.sections[0].contents = self.__safe_append_text(
            str(section_content.sections[0].contents),
            pronunciation_line,
        )
    ...
    @staticmethod
    def __safe_append_text(content: str, text):
        """
